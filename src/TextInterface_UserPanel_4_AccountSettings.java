...
public class TextInterface_UserPanel_4_AccountSettings {
    ...
    public static void changePasswordProcedure() throws IOException {
        ...
        BackEndMethods.updateCSV(Main.loggedUserLine, Main.loggedUser + "," + newPassword, "src\\Data\\Users.csv");
    ...
    public static void changeUsername() throws IOException {
        ...
        BackEndMethods.updateCSV(Main.loggedUserLine, newUsername + "," + Main.loggedUserPassword,"src\\Data\\Users.csv");
...
//            int currentLine = BackEndMethods.findCurrentLine(Main.loggedUser);
            BackEndMethods.updateCSV(Main.loggedUserLine, null,"src\\Data\\Users.csv");
